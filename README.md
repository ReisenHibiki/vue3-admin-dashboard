...
本项目是基于 **Vue3 \+ TypeScript \+ Vite \+ Pinia \+ element plus** 开发的轻量级后台管理演示系统，模拟企业级后台基础业务与权限场景。项目采用现代前端开发规范，使用组合式API开发，实现了核心的动态路由权限、角色权限区分、后台通用业务功能，后续可持续迭代拓展新功能。
...
本项目已新增配置 GitHub Actions 自动化部署流程，代码推送至 `main` 分支后自动触发构建与部署。
